...
from src.sys_surveillance_cam.src.config_loader import load_camera_config, load_all_camera_configs
...
def test_load_all_camera_configs_skips_invalid(tmp_config_dir):
    ...
    valid.write_text(yaml.dump({
        "camera_id": "cam1", "source": 0, "frame_width": 640, "frame_height": 480, "fps": 20, "codec": "mp4v"
    }))
